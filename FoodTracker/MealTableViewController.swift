...
//  FoodTracker
//
//  Created by Volodymyr Myroniuk on 10/10/18.
...
class MealTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        // Load any saved meals, othervise load sample data.
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        case "ShowDetail":
            ...
            guard let indexPath = self.tableView.indexPath(for: selectedCell) else {
                fatalError("The selected cell is not being displayed bu the table")
            }
